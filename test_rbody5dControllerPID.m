...
setappdata(0,'config_control_kp',0.26);
setappdata(0,'config_control_ki',0);
...
velocityXController = ControllerPID(dt);
%velocityYController = ControllerPID(dt);
...
while rbody.time < tf
   ...
   velocityXController.error = error_vx;
   %velocityYController.error = error_vy;
